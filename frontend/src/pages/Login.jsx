...
const Login = () => {
  ...
  return (
    <div className={`min-h-screen flex items-center justify-center p-4 transition-all duration-300 ${isDarkMode
        ...
        <div className="glass p-8 rounded-3xl">
          ...
          <div className="flex bg-black/10 dark:bg-white/5 p-1 rounded-2xl mb-8">
            <button
              ...
              className={`flex-1 py-2.5 rounded-xl text-sm font-semibold transition-all duration-300 ${!isSignUp
            ...
            <AnimatePresence mode="wait">
              {isSignUp && (
                ...
                >
                  ...
                  <div className="space-y-1">
                    <label className="text-xs font-semibold ml-1 text-gray-500 uppercase tracking-wider">Username</label>
                    <div className="relative">
                      <span className={`absolute left-4 top-1/2 -translate-y-1/2 font-bold text-sm ${isDarkMode ? 'text-white/40' : 'text-gray-400'}`}>@</span>
                      <input
                        type="text"
                        name="username"
                        required={isSignUp}
                        ...
                        className={`w-full pl-8 pr-4 p-4 rounded-2xl border-2 bg-transparent transition-all outline-none ${isDarkMode
                            ? 'border-white/10 focus:border-pink-500/50 text-white'
                            : 'border-black/5 focus:border-pink-500/50 text-gray-900'
                          }`}
                      />
                    </div>
                    <p className={`text-[10px] ml-1 ${isDarkMode ? 'text-white/30' : 'text-gray-400'}`}>Lowercase, numbers and underscores only. Cannot be changed for 60 days after setting.</p>
                  </div>
                </motion.div>
              )}
            </AnimatePresence>
